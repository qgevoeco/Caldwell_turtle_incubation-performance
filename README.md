...
[![DOI](.svg)](https://zenodo.org/badge/latestdoi/)
...
#### "eggsurvival_repository.txt" file

A tab-separated text file consisting of:

#### "hatchlingandrightingresponsedata_repository.txt" file

A tab-separated text file consisting of:

#### "hatchlingdata_repository.txt" file
